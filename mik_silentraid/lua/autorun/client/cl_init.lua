...
function SR_RaidStart_player()
	...
	timer.Create("SR_RaidTimer", 350, 0, function()//-----------------------------------------------------------------------------------------------------CHANGED BY LUNA: Changed time from 60 to 350 secs, or five min.----------------------------------------------------------------------------------
...
function SR_RaidOver_adminnet()
	...
	SR_RemoveTimer()//------------------------------------------------------------------------------------------------------------ADDED BY LUNA: if no one died nor said the raid was over then a loop ocours which ends here. killing the timer here will prevent the loop from happening---------------------------------------------------------------------------------------------------------
